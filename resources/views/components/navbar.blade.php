<nav class="sticky top-3 left-0 right-0 z-50 mb-8 self-center-safe w-full">
    <div class="mx-4 sm:mx-8 md:mx-16 lg:mx-36">
        <div class="rounded-2xl border border-border-primary/50
            ...
            <!-- Nav Links -->
            <div class="justify-self-center flex justify-center gap-7">
            ...
            <!-- Auth/User Area -->
            <div class="justify-self-center sm:justify-self-end flex justify-center sm:justify-end gap-[16px] items-center">
                @guest
                ...
                <x-button class="h-8 w- text-text-primary" id="theme-toggle"><x-icons.dark-theme-svgrepo-com/></x-button>
            </div>
        </div>
    </div>
</nav>
